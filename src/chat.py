        ...
        try:
            ...
            if intent_match:
                enhanced_message = (
                    ...
                    f"SQL query to be executed: {sql_query}. "
                    f"Answer template hint: {answer_template}. "
                    "Decide whether the template is useful based on the SQL result. Modify if needed. "
